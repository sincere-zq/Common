...
public class BaseModel<T> {
     ...
     */
    protected <T> void subscribe(Context context, final Observable observable, ObserverResponseListener<T> listener,
                                 ObservableTransformer<T, T> transformer, boolean isDialog, boolean cancelable) {
        final Observer<T> observer = new BaseObserver(context, listener, isDialog, cancelable);
